...
POST_PAGE_SIZE is how many posts each page of the public blog index (and of a
category archive) shows. POST_NAV_LABEL is the label of the public "Blog"
entry in the main navigation; the URL stays /blog either way.
"""
