"""
End-to-end tests for splent_feature_post.
...
Run with:  splent feature:test splent_feature_post --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_post")
    assert "splent_feature_post" in browser.page_source.lower()
